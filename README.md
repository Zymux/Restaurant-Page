...
In this project:
    ...
    - Used JavaScript to specifically create buttons out of the spans in nav.
    - Used JavaScript to create tab-switching logic inside of index.js with eventlisteners for each button and wiped out the contents of div#content and replaced with items such as menu and about us page.
