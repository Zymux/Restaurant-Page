export function loadAbout() {
    ...
    // Clear the existing buttons container and add an "Under Construction" message
    const buttonContainer = document.querySelector('.container-order .buttons');
    if (buttonContainer) {
        buttonContainer.innerHTML = ''; // Clear existing buttons

        const underConstructionContainer = document.createElement('div');
        underConstructionContainer.style.display = 'flex';
        underConstructionContainer.style.flexDirection = 'column';
        underConstructionContainer.style.justifyContent = 'center';
        underConstructionContainer.style.alignItems = 'center';
        underConstructionContainer.style.backgroundColor = '#FF9933';
        underConstructionContainer.style.padding = '16px';
        underConstructionContainer.style.border = '2px solid gray';
        underConstructionContainer.style.width = '100%';
        underConstructionContainer.style.boxSizing = 'border-box';
        underConstructionContainer.style.flex = '1';

        const underConstructionMessage = document.createElement('h2');
        underConstructionMessage.innerText = 'About Us Page is Under Construction';
        underConstructionMessage.style.color = 'purple';
        underConstructionContainer.appendChild(underConstructionMessage);

        buttonContainer.appendChild(underConstructionContainer);
    }
